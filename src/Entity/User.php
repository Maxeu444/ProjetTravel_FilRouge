...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\Column(length: 180, unique: true, name: "username")]
    ...
    #[ORM\OneToMany(mappedBy: 'account_id', targetEntity: Booking::class)]
